...
Example usage:
  1) Q2PEP:
     ./main.py q2pep --input qvalues.tsv --qcol q-value --pava-method ip --center-method mean --output resultsDir

  2) OBS2PEP (concatenated):
     ./main.py obs2pep --cat-file observations.tsv --score-col score --type-col label --output results.txt

  3) OBS2PEP (separate target/decoy):
     ./main.py obs2pep --target-file targetScores.tsv --decoy-file decoyScores.tsv --score-col score --output resultsDir
""",
