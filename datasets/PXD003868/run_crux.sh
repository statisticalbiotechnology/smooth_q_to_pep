...
DATA_DIR="/proj/proteoforma_nsc/smooth_q_to_pep/datasets/PXD003868"
FASTA="${DATA_DIR}/Saccharomyces-cerevisiae.fasta"
MZML="${DATA_DIR}/delPBP1_SM_1.mzML"
WORK_DIR="/proj/proteoforma_nsc/smooth_q_to_pep/${OUT_DIR}/PXD003868/run${SEED}"
