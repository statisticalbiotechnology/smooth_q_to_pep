...
DATA_DIR="/proj/proteoforma_nsc/smooth_q_to_pep/datasets/PXD004467"
FASTA="${DATA_DIR}/Apis-mellifera.fasta"
MZML="${DATA_DIR}/BM-2.mzML"
WORK_DIR="/proj/proteoforma_nsc/smooth_q_to_pep/${OUT_DIR}/PXD004467/run${SEED}"
