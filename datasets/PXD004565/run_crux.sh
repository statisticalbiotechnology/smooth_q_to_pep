...
DATA_DIR="/proj/proteoforma_nsc/smooth_q_to_pep/datasets/PXD004565"
FASTA="${DATA_DIR}/Bacillus-subtilis.fasta"
MZML="${DATA_DIR}/151012_QEp_PK_Sec_3_2_DDA.mzML"
WORK_DIR="/proj/proteoforma_nsc/smooth_q_to_pep/${OUT_DIR}/PXD004565/run${SEED}"
