...
DATA_DIR="/proj/proteoforma_nsc/smooth_q_to_pep/datasets/PXD004424"
FASTA="${DATA_DIR}/H.-sapiens.fasta"
MZML="${DATA_DIR}/151009_exo3_1.mzML"
WORK_DIR="/proj/proteoforma_nsc/smooth_q_to_pep/${OUT_DIR}/PXD004424/run${SEED}"
