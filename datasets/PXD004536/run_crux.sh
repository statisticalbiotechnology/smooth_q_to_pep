...
DATA_DIR="/proj/proteoforma_nsc/smooth_q_to_pep/datasets/PXD004536"
FASTA="${DATA_DIR}/Candidatus-endoloripes.fasta"
MZML="${DATA_DIR}/Run2_83-g1_2000ng.mzML"
WORK_DIR="/proj/proteoforma_nsc/smooth_q_to_pep/${OUT_DIR}/PXD004536/run${SEED}"
